...
export default function BookContent() {
    ...
    const SelectChapter =(event)=> {
        navigate("/admin/BookContent",{state: {status: bookStatus, chid: event, bookid: bookID.current, bookname: bookname, chapter:chapter}});
                ...
                <div className="select-ep top">
                    <div className="select-ch">
                        ...
                        {nextChapter ? 
                            ...
                            <button className="back-to-book" onClick={()=>{navigate("/admin/bookdetailApprove",{state : {bookID : bookID.current}})}}><span><Icon2.AiOutlineQuestionCircle /></span>กลับไปที่หน้าหนังสือ</button>
                        }
                    </div>
                </div>
            </div>
